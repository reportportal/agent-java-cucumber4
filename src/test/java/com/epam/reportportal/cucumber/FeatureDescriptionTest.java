...
public class FeatureDescriptionTest {
	...
	private static final Pair<String, String> FEATURE_CODE_REFERENCES = Pair.of("file:", "src/test/resources/features/belly.feature");

	private static final Pair<String, String> SCENARIO_CODE_REFERENCES = Pair.of("file:", "src/test/resources/features/belly.feature");
